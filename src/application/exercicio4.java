...
//dólares a ser comprado por uma pessoa em reais. Informar quantos reais
//a pessoa vai pagar pelos dólares, considerando ainda que a pessoa terá
...
public class exercicio4 {
	...
	public static void main(String[] args) {
		...
		double total = CurrencyConverter.converter(coin, amount);
